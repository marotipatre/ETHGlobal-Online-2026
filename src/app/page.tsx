...
const steps = [
  ["01", "Sign on Somnia", "Users keep their existing wallet and sign a source-chain intent."],
    ...
    <div className="mx-auto max-w-6xl pb-12 pt-8 md:pt-16">
      <section className="grid items-end gap-10 border-b border-[var(--line)] pb-16 lg:grid-cols-[1.3fr_.7fr]">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[var(--muted)]">Universal Arc Kit gives Somnia users a direct intent path to Arc Testnet. The wallet, source chain, gateway, relayer, and execution contract each keep their own job.</p>
        ...
        <div className="remit-card p-6"><p className="text-xs font-bold tracking-[.16em] text-[var(--muted)]">DESTINATION NETWORK</p><p className="mt-3 text-3xl font-bold text-white">Arc Testnet</p><div className="my-6 h-px bg-[var(--line)]" /><div className="space-y-3 text-sm text-[var(--muted)]"><p className="flex gap-2"><Check className="size-4 shrink-0 text-[var(--primary)]" /> Existing RainbowKit wallet flow</p><p className="flex gap-2"><Check className="size-4 shrink-0 text-[var(--primary)]" /> Somnia source-chain intents</p><p className="flex gap-2"><Check className="size-4 shrink-0 text-[var(--primary)]" /> Arc relayer execution history</p></div></div>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-3"><article className="remit-card p-6"><Zap className="size-5 text-[var(--primary)]" /><h3 className="mt-5 font-bold text-white">No network confusion</h3><p className="mt-2 text-sm leading-relaxed text-[var(--muted)]">The existing wrong-network handling continues to guide users to Somnia.</p></article><article className="remit-card p-6"><Layers3 className="size-5 text-[var(--primary)]" /><h3 className="mt-5 font-bold text-white">Real Arc state</h3><p className="mt-2 text-sm leading-relaxed text-[var(--muted)]">Counter and Todo reads remain pointed at their Arc Testnet contracts.</p></article><article className="remit-card p-6"><Code2 className="size-5 text-[var(--primary)]" /><h3 className="mt-5 font-bold text-white">Intent-native demos</h3><p className="mt-2 text-sm leading-relaxed text-[var(--muted)]">All existing gateway calldata and relayer behavior remain unchanged.</p></article></section>
